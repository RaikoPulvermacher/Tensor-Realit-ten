...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.85\textwidth]{"Tensor der Realitaeten"}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.85\textwidth]{"Energie flucht"}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.85\textwidth]{"Atome beschreibung"}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.85\textwidth]{"Neutron entwicklung"}
